  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "gradient-hero text-white font-semibold shadow-elevated hover:shadow-elevated hover-lift hover-glow",
        course: "bg-card text-card-foreground border border-border hover:bg-accent hover:text-accent-foreground hover-lift shadow-card",
        login: "gradient-primary text-white font-medium shadow-card hover:shadow-elevated hover-lift",
      },
      size: {
