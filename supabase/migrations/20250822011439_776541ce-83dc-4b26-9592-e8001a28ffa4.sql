-- Add unique constraint to lessons table for conflict resolution
ALTER TABLE public.lessons ADD CONSTRAINT lessons_course_order_unique UNIQUE (course_id, order_index);
